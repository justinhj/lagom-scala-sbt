...
/**
  * This is an event sourced entity. It has a state, [[LagomhelloState]], which
  ...
  */
class LagomhelloEntity extends PersistentEntity {

  override type Command = LagomhelloCommand[_]
  override type Event = LagomhelloEvent
  override type State = LagomhelloState
  ...
  override def behavior: Behavior = {
    case LagomhelloState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
...
object LagomhelloState {
  /**
    ...
    */
  implicit val format: Format[LagomhelloState] = Json.format
}

/**
  * This interface defines all the events that the LagomhelloEntity supports.
  */
sealed trait LagomhelloEvent extends AggregateEvent[LagomhelloEvent] {
  def aggregateTag: AggregateEventTag[LagomhelloEvent] = LagomhelloEvent.Tag
}

object LagomhelloEvent {
  val Tag: AggregateEventTag[LagomhelloEvent] = AggregateEventTag[LagomhelloEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends LagomhelloEvent
...
/**
  ...
  */
sealed trait LagomhelloCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends LagomhelloCommand[Done]
...
/**
  ...
  * application loader.
  */
object LagomhelloSerializerRegistry extends JsonSerializerRegistry {
